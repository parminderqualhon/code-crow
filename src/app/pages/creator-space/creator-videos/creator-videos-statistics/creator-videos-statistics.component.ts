...
@Component({
    selector: 'app-creator-videos-statistics',
    templateUrl: './creator-videos-statistics.component.html',
    styleUrls: ['./creator-videos-statistics.component.scss']
})
export class CreatorVideosStatisticsComponent implements OnInit {
    @Input() videos: any
